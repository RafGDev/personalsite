...
const projects: Project[] = [
  {
    name: 'Roamio',
    description: ['Roamio is a startup that I helped get the initial infrastructure set up for. This includes hosting, continious deployment with AWS, authentication via firebase and initial UI development.'],
    images: [amioImage1, amioImage2, amioImage3],
    link: 'https://amio.kiwi'
  },
  {
